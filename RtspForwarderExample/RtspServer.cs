...
namespace RtspForwarderExample
{
    ...
    internal class RtspServer : IDisposable
    {
        ...
        internal RtspServer(int portNumber, string username, string password, ILoggerFactory loggerFactory)
        {
            if (portNumber < System.Net.IPEndPoint.MinPort ||
                portNumber > System.Net.IPEndPoint.MaxPort)
            {
